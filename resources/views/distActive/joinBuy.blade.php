...
<div class="text_center fz">
    ...
    <div class="bgban2">
        <ul class="clearfix">
            ...
            ?>
            @if($disCourse->team_people == 3 || $disCourse->team_people == 2)
                <li>
                    <div class="pImg">
    ...
    <div class="nowPin">
        ...
        <a href="/dist/buy/{{$disCourse->id}}.html">
            <img class="pinqiImg" src="{{env("IMG_URL")}}{{$disCourse->cover_url}}" alt="">
        </a>
    </div>
    <!-- 正在拼团的课程 end -->
        ...
        @else
            ...
            @else
                ...
                @else
                    ...
                    @else
                        <a href="javascript:void (0)" class="pPosBtn f36">已购买</a>
                    @endif
                @endif
            @endif
        @endif
        ...
        <div class="weui-popup__modal fz"><!-- style="height: inherit;" //如果高度不能滑动加上前方这个style-->
            ...
            <div class="modal-content bgc_white text_left">
                <div class="plr40 mor_list fz color_333">
                    <h3 class="ptb20 f32 bold">{{$trainTitle}}（第{{$orderCourse->stage}}期）</h3>
                ...
                <div class="weui-cell weui-cell">
                    <div class="weui-cell__bd">
                        <h2 class="f28 bold">{{$disCourse->team_people}}人拼团价</h2>
                    </div>
                    <div class="weui-cell__ft">
                        <span class="price">{{$disCourse->team_price}}元</span>
                    </div>
                </div>
                @if($hasCoupon)
                    <div class="weui-cell weui-cell">
...
<script>
    ...
    //跳转登陆函数
    var gp_id = '{{$disCourse->id}}';
    var href_url = "/train/join/"+fission_id+"t"+gp_id+".html";
    ...
    function jsApiCall()
    {
        ...
        var data = {class_id:c_c_id,_token:_token,dis_id:fission_id,sponsor_id:fission_id};
    ...
    //免费报名成功或者购买成功后跳转
    function href_go(){
        location.href = "/train/success/t{{$disCourse->id}}.html";
    }
    //立即付款弹出框
    $('.payBtn').click(function (){
        ...
        if(payfrom=="WXPAY"){
            if(is_weixin==1){
                ...
                var buy_price = final_price;
                var data = {c_id:c_c_id,_token:token, dis_id:fission_id,sponsor_id:fission_id};
