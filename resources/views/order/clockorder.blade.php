...
@section('title')
    <title>赛普社区-挑战打卡{{env('WEB_TITLE')}}</title>
@endsection
...
@section('content')
	...
	<div class="nav-dingdan text_center f28 fz">
		<ul class="clearfix">
			<li><a href="/order/group">就业课程</a></li>
			<li><a href="/order/course">精品单课</a></li>
			<li><a href="javascript:void (0)" class="on">挑战打卡</a></li>
		</ul>
	</div>
	<!--小导航 end-->
	<!--====================================本喵是分割线  喵喵~========================================================-->
		...
		<ul>
			...
			<li class="bgcolor_fff plr30 fz mb20 ptb30">
				...
				<div class="weui-cell padding0 noafter nobefore mt30 mb30">
					<div class="weui-cell__bd f32 color_333 fz bold"><p>{{$item->dis_course_class_title}}</p></div>
				...
				<div class="weui-cell padding0 noafter nobefore">
					...
					<div class="weui-cell__ft f24 color_333">
						@if($item->state==0)
						<a href="/dist/buy/{{$item->dis_course_class_id}}.html" class="btn-dd plr30 border-radius-img bgcolor_orange">付款</a>
						@endif
					</div>
				</div>
			</li>
			...
			<!-- <li class="bgcolor_fff plr30 fz mb20 ptb30">
				<div class="weui-cell padding0 noafter nobefore">
					<div class="weui-cell__bd f24 color_gray9b"><p>订单编号：201904061820XXX</p></div>
					<div class="weui-cell__ft f24 color_F5A623">报名成功</div>
				</div>
				<div class="weui-cell padding0 noafter nobefore mt30 mb30">
					<div class="weui-cell__bd f32 color_333 fz bold"><p>孕产教练实战训练营（第三期）</p></div>
					<div class="weui-cell__ft f32 color_333 fz bold "><p class="d-in-black f24">￥</p>499</div>
				</div>
				<div class="weui-cell padding0 noafter nobefore">
					<div class="weui-cell__bd f26 color_gray666"><p>订单时间：2019-04-16  18:22</p></div>
					<div class="weui-cell__ft f24 color_333"><a href="javascript:void(0)" class="btn-dd btn-dd-border plr30 border-radius-img">退款</a></div>
				</div>
			</li> -->
		</ul>
	</div>
