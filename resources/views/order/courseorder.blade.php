...
@section('content')
	...
	<div class="nav-dingdan text_center f28 fz">
		<ul class="clearfix">
			...
			<li><a href="javascript:void (0)" class="on">精品单课</a></li>
		...
		<ul>
			...
			<li class="bgcolor_fff plr30 fz mb20 ptb30">
				...
				<div class="weui-cell padding0 noafter nobefore mt30 mb30">
					<div class="weui-cell__bd f32 color_333 fz bold"><p>{{$item->course_class_title}}</p></div>
				...
				<div class="weui-cell padding0 noafter nobefore">
					...
					<div class="weui-cell__ft f24 color_333">
						@if($item->state==0)
						<a href="/course/detail/{{$item->course_class_id}}.html" class="btn-dd plr30 border-radius-img bgcolor_orange">付款</a>
						@endif
					</div>
				</div>
			</li>
