...
<div id="page"><!--导航大盒子id=page 开始  【结束在最底部】-->
				...
				<div class="plr56 portrait mb26 pb10">
					<ul class="clearfix img_avatar" >
						@if(isset($data[0]))
							...
							@endforeach
							@for ($i = 0; $i < 4-$num; $i++)
								<li class="fl"  @if($i == 0) id = "img_replace" @endif></li>
							@endfor
			...
			<div class="btn f32 bold fz text_center color_333 mt70 pb136">
				...
				{{--@else--}}
					{{--@if($userid == $id)--}}
						...
						{{--@endif--}}
					{{--@else--}}
						{{--<a class="bgcolor_orange border-radius-img is_get" data-attr = "2" href="javascript:void (0)">免费认领--}}
							{{--<img class="in-black" src="/images/zt/assistance/click.png" alt="">--}}
						{{--</a>--}}
					{{--@endif--}}
				{{--@endif--}}
			...
			<div class="bd" id="tabBox1-bd">
				<div class="con ">
					<div class="plr30 mb40 jianjie">
						...
						{{--<p class="fz f30 color_gray666 text-jus text-intent3 mt32">孕产教练必备的线上课程！如何帮助产后妈妈抓住恢复期，快速瘦下来？产后恢复的黄金恢复期是什么？顺产、剖腹产如何饮食和训练？在这里，你将得到市场上最全的孕产教练攻略，赶快加入吧~</p>--}}
						{{--<br>--}}
	...
	<!--底部banner start-->
	<div class="bottom-banner plr30 bgcolor_gray">
		<img class="pt30 pb136" src="/images/share/img-b.png" alt="">
	...
	?>
	<!--悬浮按钮 start-->
	<div class="footer-x fz bold f32 color_333 text_center bgcolor_orange">
		<ul class="clearfix">
			@if($userid == $id)
				@if($mobile == 0)
					<li class="fl" onclick="userlogin()"><a class="d-in-black" href="javascript:void (0)">邀请好友助力</a></li>
					<li class="fr"  onclick="userlogin()"><a class="d-in-black" href="javascript:void (0)">免费认领</a></li>

				@else
					@if($num > 3)
						<li class="fl"><a class="d-in-black" onclick="layer.msg('您的好友已满哦。');" href="javascript:void (0)">邀请好友助力</a></li>
						<?php
						...
						@if($subscribe == 1)
							@if($studying == 1)
								<li class="fr"><a class="d-in-black is_get" data-attr = "1" href="javascript:void (0)">免费认领</a></li>
							@else
								<li class="fr"><a class="d-in-black is_get" data-attr = "0" href="javascript:void (0)">免费认领</a></li>
							@endif
						@else
							<li class="fr"><a class="d-in-black kwg" href="javascript:void (0)">免费认领</a></li>
						@endif
					@else
						<li class="fl"><a class="d-in-black" href="/wechat/shareArticle/39?aid=3&&userid={{$userid}}">邀请好友助力</a></li>
						<li class="fr"><a class="d-in-black is_get" data-attr = "5" href="javascript:void (0)">免费认领</a></li>
			...
			@else
				@if($mobile == 0)
					<li class="fl" onclick="userlogin()"><a class="d-in-black" href="javascript:void (0)">马上助力</a></li>
				@else
					@if($num > 3)
						<li class="fl"><a class="d-in-black" id="friend_zhuli" data-attr = "2" href="javascript:void (0)">马上助力</a></li>
						@else
						<li class="fl"><a class="d-in-black" id="friend_zhuli" data-attr = "0" href="javascript:void (0)">马上助力</a></li>
					@endif
				@endif
				<li class="fr"><a class="d-in-black" href="/assistance/friend/{{$id}}.html">我也要领取</a></li>
			@endif
		</ul>
	</div>
	<!--悬浮按钮 end-->
...
<script type="text/javascript">
	...
	var userlogin = function(){
		var userid = "{{$userid}}";
		var id_zhu = "{{$id}}";
		var url = "/assistance/index/"+id_zhu+".html";
		...
		{{--if (status == 0){--}}
			...
			{{--$.ajax({--}}
				...
				{{--success: function (data) {--}}
					...
					{{--layer.msg("恭喜您已领到课程。");--}}
					{{--window.location.href = "/course/detail/38.html";--}}
	...
	$("#friend_zhuli").click(function(){
		...
		if(status == 0){
			...
			var token = '{{csrf_token()}}';
			var data = {userid:userid,friend:friend,_token:token};
			$.ajax({
				url:'/assistance/zhuli',
				type:'POST',
				data:data,
				dataType:'json',
				success:function(data){
					if(data.code == 1){
						layer.msg("助力成功");
						<?php
							$avatar = DB::table("users")->where("id",$userid)->select("avatar")->first();
						?>
						var avatar = "{{$avatar?$avatar->avatar:'/images/zt/assistance/hui.png'}}";

						var str = '<img class="border-radius50" src="'+avatar+'" alt="">';
						$("#img_replace").append(str);
