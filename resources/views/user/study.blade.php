        ...
        <div class="list" id="list">
            <ul>
                ...
                <a href="/course/detail/{{$v->id}}.html">
                    <li class="ptb30">
                    <dl class="clearfix">
                        <dt class="border-radius-img"><img src="{{env('IMG_URL')}}{{$v->cover_url}}" alt="" /><span class="bgcolor_orange text_center fz color_333">{{$v->level}}</span></dt>
                        <dd>
...
<!-- <div class="fixed_bar_bottom">
   <div class="weui-tabbar nav-tabbar">
      ...
      <a href="/user/studying" class="weui-tabbar__item weui-bar__item--on"><span class="ico_study"></span></a>
                ...
                success:function(result){
                    ...
                    if(result.code==1){
                        for (var i in result.list) {
                            ...
                            $("#list").append("" +
                            "<a href='/course/detail/"+result.list[i].id+".html'><li class='ptb30'>" +
                            "<dl class='clearfix'>" +
                            "<dt class='border-radius-img'><img src='"+www+result.list[i].cover_url+"' alt=''/><span class='bgcolor_orange text_center fz color_333'>"+result.list[i].level+"</span></dt>" +
                            "<dd>" +
