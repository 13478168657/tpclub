...
<head>
    ...
    <link rel="stylesheet" href="/css/zt/zt_RightFloat.css?t=1">
    {{--本页面css--}}
    ...
    <style>
        ...
        /*悬浮底部*/
        .footer{;position: fixed;bottom: 0;left: 0;width: 100%;height: 3rem;z-index: 999;padding-top: .5rem;box-shadow: 0 0 3px rgba(221,221,221,1);background-color: #fff;}
        .footer button{width: 100%;height: 2rem;line-height: 2rem;overflow: hidden;background: #fff;}
        .footer span.f_text{;display: inline-block;width: 80%;background-color: #18BB08;height: 2rem;line-height: 2rem}
        .footer span.f_img{width: 20%;}
        .footer img{vertical-align: middle;display: inline-block;width: 50%;
        }
    </style>
    <script>
        (function(){
    ...
    <div>
        ...
        @else
            <div class="footer color_fff">
                <button class="clearfix pr30 codeWBtn">
                    <span class="fl f_img"><img src="/images/weixin.png" class="img100 icon_img_dong" alt=""></span>
                    <span class="fr f_text border-radius50 color_fff fz f30 bold">微信咨询&nbsp;&nbsp;&nbsp;了解课程详情</span>
                </button>
            </div>
        @endif
        <!-- 悬浮按钮 end-->
...
<script>
    ...
    $('.codeWBtn').click(function(){
        layer.open({
            ...
            '<img src="/images/baowx.jpg" alt="赛普健身社区" class="mt32">' +
            '<p class="fz f30 color_333 mb10 bold pt40 ">添加导师微信</p>' +
            '<p class="plr30 fz f40 color_333">' +
            '<span class="block bold">咨询课程详情</span>' +
            '</p>' +
            '</div>',
            btn:false
        });
