        ...
        <div class="content">
            ...
            <div class="ptb20">
                <div class="zaoniao_btn mt60 plr25 clearfix text_center relative">
                    ...
                    <a href="javascript:void (0)" data-stage="2" onclick="zao_show2(this);" class="button border-radius50 fz f24 bga">11月9号开班</a >
                    <a href="javascript:void (0)" data-stage="3" onclick="zao_show3(this);" class="button border-radius50 fz f24 ">12月9号开班</a >
                </div>
            </div>
            <!--按钮切换 end-->
            ...
            <div class="foot_u">
                <ul class="clearfix">
                    ...
                    <li class="leftW clearfix plr20" id="zao2">
                        <div class="fl nth1">
                            <span class="block fz f22 bold">11月9日开班</span>
                    ...
                    <li class="leftW clearfix plr20 none" id="zao3">
                        <div class="fl nth1">
                            <span class="block fz f22 bold">12月9日开班</span>
                            <span class="block fz f22 bold">还剩<span class="color_be3f00">{{$stageNumArr[3]}}</span>个名额</span>
                        </div>
                        @if($add_info)
                            <div class="fr nth2" onclick="javascript:window.location='/activeCourse/addUserInfo/{{$data->id}}.html?fid={{$fission_id}}'">
                                <img src="/images/wanshan.png" alt="">
                            ...
                            @else
                                ...
                                @else
                                    @if($add_info)
                                        ...
                                        <span class="f43 mr20 color_be3f00">{{$price}}<b class="f19">元</b></span>
                                        <span class="f30 f30">马上报名</span>
                                    @else
                                        <button class="fz color_5c2a0c open-popup">
