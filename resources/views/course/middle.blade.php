...
<div class="saomiao ">
    <p><img src="/images/bm_success.png" alt=""></p>
    <p><img src="/images/qr.png" alt=""></p>
    <p class="text_center pt40 fz f32">扫描二维码获得课程提醒</p>
</div>

<!--大按钮-->
<div class="Btn nobefore noafter fix_btn">
    <a href="javascript:;" class="weui-btn nobefore noafter bgcolor_orange fz color_333 f34">进入课程</a>
</div>


<!--大按钮-->
<div class="Btn nobefore noafter fix_btn">
    <a href="/course/video/{{$c_c_id}}/{{$video_id}}.html" class="weui-btn nobefore noafter bgcolor_orange fz color_333 f34">进入课程</a>
</div>
