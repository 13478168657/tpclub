							...
							@if(count($two) > 0)
								@foreach($two as $k => $a)
									...
									@endif
										...
										<div class="weui-cell foot nobefore mlr30" style="border-bottom: 1px solid #eee;">
											<div class="weui-cell__bd text_right">
												<a href="" class="color_gray9b f25">查看详情</a>
											</div>
										</div>
						</li>
					@endforeach
	...
	<div id="full" class='weui-popup__container bgcolor_fff ask_popup'>
		...
		<div class="weui-popup__modal bgcolor_fff">
			...
			<div class="ask_con">
				...
				<textarea placeholder="请发表您的评论…" id="content">@某某某</textarea>
			</div>-->
				<div class="">
