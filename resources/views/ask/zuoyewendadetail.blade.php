        ...
        <div class="page_ask bgcolor_gray">
            ...
            <div class="daoshizuoye_box bgcolor_fff HuidaImgMax pb30">
                ...
                <div class="weui-cell nobefore foot f24 pt0">
                    <div class="weui-cell__bd color_gray9b">{{$question->view}}阅读· {{date("Y.m.d",strtotime($question->created_at))}}</div>
                    <?php
                    $imgList = $question->imgurl_list;
            ...
            <ul class="list_daoshizuoye mt20">
                @if($answer)
                    <li>
                        <?php
                        $user = DB::table("users")->where("id",$answer->author_id)->select("name","nickname","avatar","introduction")->first();
                            ...
                            <div class="pl_item noafter first_data{{$v->id}}">
                                <div class="clearfix">
                                    ...
                                    @else
                                        ...
                                        @else
                                        <div class="btn_reply fr open-popup" onclick="two_open(this);" first_key="{{$v->id}}" author_name="" author_id = "{{$v->id}}" data-level="2"><span>回复</span>
                                        @endif
                                        </div>
                                    @endif
                                </div>
                                    ...
                                    <div class="hf_item bgcolor_f9f9f9">
                                        <div class="clearfix">
                                            ...
                                            <div class="info fl">
                                                ...
                                                @else
                                                    <span class="f32 bold name ml20"></span>
                                                @endif
                                            </div>
                                        </div>
                                        <p class="cont">
